    ...
    return(
      <View style={{width:'100%',marginTop:20}}>
        ...
        <View style={{flexDirection:'row', justifyContent:'space-between'}}>
            <View>
                <Text style={{fontSize:12,fontWeight:'800',color:"#ff5a5f"}}>{this.props.informationListing.acceptedApplicants.length}/{this.props.informationListing.amountOfParticipants} GUESTS APPROVED</Text>
            ...
            <View style={{alignItems:'center',justifyContent:'center'}}>
              <View style={{backgroundColor:'#ff5a5f',paddingTop:10,paddingBottom:10,paddingLeft:20,paddingRight:20,borderRadius:5}}>
                <TouchableOpacity>
                <Text style={{color:"white"}}>In request</Text>
                </TouchableOpacity>
              </View>
            </View>
        </View>
